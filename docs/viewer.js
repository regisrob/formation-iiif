/*
 * Javascript code taken from https://github.com/IIIF/training/blob/master/iiif-online-workshop/day-two/viewer.js
 * Author: Glen Robson (@glenrobson) 
 * Source: IIIF Consortium - Training: https://github.com/IIIF/training
 * License:  CC-BY-4.0 
*/
...
function addIdentifiers(ul, config) {
    ...
    ul.appendChild(li);
    li.appendChild(createDescription('Base URL'));
